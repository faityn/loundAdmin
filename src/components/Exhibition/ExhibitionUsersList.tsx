...
import {  getExhibitionUsersList } from "@/hooks/useEvents";
import { FiEdit } from "react-icons/fi";
const ExhibitionUsersList = () => {
  ...
  const getData = async () => {
    const response = await getExhibitionUsersList();
            ...
            >
              <div className="relative">
                <input
                  ...
                  checked={
                    checkedElements.length === itemsList?.length ? true : false
                  }
                />
                <div
...
export default ExhibitionUsersList;
