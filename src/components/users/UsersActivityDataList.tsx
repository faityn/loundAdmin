          ...
          {isOpen ? (
            <CustomModal>
              <h2 className="text-xl text-black">
                ({checkedUsers?.length}) {checkedUsers?.length > 1 ? 'Users' : 'User' } will <br /> be
                deleted
              </h2>
            ...
            >
              <div className="relative">
                <input
                  ...
                  checked={
                    checkedUsers.length === userAllList?.length ? true : false
                  }
                />
                <div
            ...
            <tr key={index}>
              ...
              >
                <div className="relative">
                  ...
                  <div
                    className={`mr-4 flex h-4 w-4 items-center justify-center rounded border ${
                      checkedUsers.includes((item?.id as unknown) as string) &&
                      "border-primary bg-gray dark:bg-transparent"
                    }`}
                  >
                    <span
