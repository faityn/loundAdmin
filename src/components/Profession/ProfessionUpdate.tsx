"use client";
import { menuPermissionAtom, professionDetailAtom } from "@/atom";
...
import { getProfessionDetail, updateProfession } from "@/hooks/useData";
...
const ProfessionUpdate = ({ id, url }: Props) => {
  ...
  const [itemsDetail, setItemsDetail] = useRecoilState(professionDetailAtom);
  ...
  const getData = async () => {
    ...
    const response = await getProfessionDetail(String(userToken), id);
  ...
  const onSubmit: SubmitHandler<FormData> = async (data) => {
    ...
    const res = await updateProfession(String(token), id, title);
